...
function addBuildPhases(xcodeProject, { targetUuid, groupName, productFile, resources, }) {
    ...
    // Sources build phase
    xcodeProject.addBuildPhase(["ShareExtensionViewController.swift"], "PBXSourcesBuildPhase", groupName, targetUuid, targetType, buildPath);
    ...
    xcodeProject.addBuildPhase(resources, "PBXResourcesBuildPhase", groupName, targetUuid, targetType, buildPath);
